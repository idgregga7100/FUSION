#FUSION runs one chr at a time, so combine the separate chromosome files into single phenotype files. mhc region is also run separately
#example data from Schlidkraut cancer sumstats
...
#read in chr1, add on each following chr file and mhc
for (pheno in phenos){
